function [missrate, grp, bestRank, minNcutValue,W, index] = RSIM_JBLD_oneshot(X, s, UpperD, LowerD, camID)
...
for ii = 1:length(r)
	...
	Wr = real(Z.^3.5); % enhance block-diagonal structure; 
...
%     W(camID==2, camID==1) = W3';
	...
	L = Lambda*W;	
    opts.tol = 1e-6;
	eigenValues = eigs(L,K+1, 'LM', opts);	% you can also easily modify the ncutW function and 
